...
class AllowedType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/master/mod_tokens.asciidoc#141-allowedtype-enum
    """
...
class WhitelistType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/master/mod_tokens.asciidoc#145-whitelisttype-enum
    """
    always = 'ALWAYS'
    allowed = 'ALLOWED'
